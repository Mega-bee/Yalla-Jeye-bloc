        ...
        children: [
          ...
          Stepper(
            ...
            controlsBuilder: (context, details) {
              ...
              else if (details.currentStep == 6 && orderDetailsResponse.statusId == 5 && orderDetailsResponse.requiresRating ){
            ...
            steps: [
              ...
              if (orderDetailsResponse.statusId != 6 && orderDetailsResponse.statusId != 8 && orderDetailsResponse.statusId != 10)
                Step(
                    title: Text("Delivered"),
                    subtitle: Text("Hope you had a good service"),
                    content: Container(),
                    isActive: currentStep == 6 ?true :false,state:  currentStep == 6 ? StepState.complete :StepState.indexed)
