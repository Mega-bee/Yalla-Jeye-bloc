    ...
    return Padding(
      ...
      child: Column(
        children: [
          Card(
            color:
                order.statusId == 9 ? Colors.blueGrey.shade100 : Colors.white,
            elevation: 5,
            shape:
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    title: Text('Reorder success'),
                                    content: Text(
                                        'Your Reorder has been successfully created. '),
                                    actions: [
                                      TextButton(
                                        child: Text('OK'),
                                        onPressed: () {
                              ...
                              // screenState.reOrder(ReorderRequest(
                              // //   orderId: orderDetailsResponse.isCustom
                              // //       ? orderDetailsResponse.id
                              // //       : orderDetailsResponse.id,
                              // // ));
                            },
                            child: Text(
