...
class AddressCard extends StatefulWidget {
  ...
  const AddressCard(
      {required this.model, required this.onEdit, required this.onDelete ,required this.isSelectedPage, required this.onSelect});
...
class _AddressCardState extends State<AddressCard> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
         onTap: widget.isSelectedPage ? widget.onSelect :(){},
        child: Card(
          elevation: 5,
          ...
          Row(
            ...
            trailing:widget.isSelectedPage ?   Padding(
